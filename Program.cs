        ...
        exectionPlan
            .AddFunction(
                (new Function("PrintThree"))
                    .AddInstruction(new OpCode(OpCodeTable.Def, "FLOAT", "result"))
                    .AddInstruction(new OpCode(OpCodeTable.Loadi, "result", "3.5"))
                    .AddInstruction(new OpCode(OpCodeTable.Puti, "result"))
                    .AddInstruction(new OpCode(OpCodeTable.Call, "__N_Output_WriteLine"))
            ...
            .AddFunction(
                (new Function("Sum"))
                    ...
                    .AddInstruction(new OpCode(OpCodeTable.Def, "FLOAT", "y"))
                    .AddInstruction(new OpCode(OpCodeTable.Popi, "y"))
                    .AddInstruction(new OpCode(OpCodeTable.Def, "FLOAT", "x"))
            ...
            .AddFunction(
                (new Function("Main"))
                    .AddInstruction(new OpCode(OpCodeTable.Def, "FLOAT", "x"))
                    .AddInstruction(new OpCode(OpCodeTable.Loadi, "x", "200.1"))
                    .AddInstruction(new OpCode(OpCodeTable.Def, "FLOAT", "y"))
                    .AddInstruction(new OpCode(OpCodeTable.Loadi, "y", "500.2"))
                    .AddInstruction(new OpCode(OpCodeTable.Def, "INT", "z"))
                    ...
                    .AddInstruction(new OpCode(OpCodeTable.Def, "FLOAT", "tmp"))
